...
/**
 * 专区申请审核列表（内容组件）：弹窗（ZoneVerifyModal）与专区管理后台页面共用。
 */
const ZoneVerifyList: React.FC<ZoneVerifyListProps> = ({ zoneId, zoneName, active = true }) => {
