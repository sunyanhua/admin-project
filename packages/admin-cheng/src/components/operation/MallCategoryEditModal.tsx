...
export interface MallCategoryEditModalProps {
  visible: boolean;
  mode: 'create' | 'edit';
...
const MallCategoryEditModal: React.FC<MallCategoryEditModalProps> = ({
  visible, mode, category, parentId, onClose, onSuccess,
}) => {
...
export default MallCategoryEditModal;
