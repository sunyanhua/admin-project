...
export const userApi = {
   ...
   * 按 topic_key 必填；user_id/score_field/operator_type/reason 模糊/时间区间可选筛选；created_at DESC 分页
   */
  getTopicScoreLogs: (topicKey: string, params?: {
    page?: number; size?: number; user_id?: string; score_field?: number;
    operator_type?: number; reason?: string; start_at?: string; end_at?: string;
  }) => {
