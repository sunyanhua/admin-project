...
import MallCategoryEditModal from '@/components/operation/MallCategoryEditModal';
...
const ProductCategoryManagement = () => {
  ...
  return (
    <>
      <StandardPage title="商品分类管理" description="管理商品分类，支持上下架、显隐控制及权重排序。"
      ...
      />
      <MallCategoryEditModal visible={editModalVisible} mode={editMode} category={selectedCategory} parentId={3}
