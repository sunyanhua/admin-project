...
> 版本：v1.1 | 日期：2026-08-03 | 协议：HTTPS | 格式：JSON | 编码：UTF-8
...
| `urn:bizmall:source:read` | 来源管理 | 查看来源列表/详情、注册统计、上报统计 |
| `urn:bizmall:source:write` | 来源管理 | 创建/编辑来源 |
| `urn:bizmall:source:delete` | 来源管理 | 删除来源（软删除） |
| `urn:bizmall:datacube:read` | 数据统计 | 查看留存/摘要/画像/访问趋势/分布/页面等统计 |
| `urn:bizmall:verification:read` | 核销 | 查看核销人员列表/详情、核销记录 |
| `urn:bizmall:verification:write` | 核销 | 创建/编辑/删除核销人员、生成绑定码、解除绑定 |

> **注意：** 以下模块的后台接口未绑定细粒度 URN，仅要求 `AdminAuth`（管理员已登录）即可访问：操作日志、后台上传图片、通知发送记录查询。
...
| GET | `/admin/v1/mall/products/:id` | 查询商品详情（后台） | AdminAuth | `urn:bizmall:product:write` |
| PUT | `/admin/v1/mall/products/:id` | 编辑商品 | AdminAuth | `urn:bizmall:product:write` |
| DELETE | `/admin/v1/mall/products/:id` | 删除商品（软删除） | AdminAuth | `urn:bizmall:product:write` |
...
| GET | `/admin/v1/mall/products/:id/skus` | 查询商品SKU列表 | AdminAuth | `urn:bizmall:product:write` |
| POST | `/admin/v1/mall/products/:id/skus` | 批量创建SKU | AdminAuth | `urn:bizmall:product:write` |
| DELETE | `/admin/v1/mall/products/:id/skus` | 删除商品全部SKU | AdminAuth | `urn:bizmall:product:write` |
...
| GET | `/admin/v1/mall/products/:id/specs` | 查询商品规格组列表 | AdminAuth | `urn:bizmall:product:write` |
...
| DELETE | `/admin/v1/mall/products/:id/specs/:spec_id` | 删除规格组 | AdminAuth | `urn:bizmall:product:write` |
...
| 方法 | 路径 | 摘要 | 认证 | 所需权限 |
|:----:|------|------|:----:|:----:|
| GET | `/admin/v1/mall/products/:id/booking-slots` | 预约时段列表 | AdminAuth | `urn:bizmall:product:write` |
| POST | `/admin/v1/mall/products/:id/booking-slots` | 创建预约时段 | AdminAuth | `urn:bizmall:product:write` |
| DELETE | `/admin/v1/mall/products/:id/booking-slots` | 批量删除预约时段 | AdminAuth | `urn:bizmall:product:write` |
| PUT | `/admin/v1/mall/products/:id/booking-slots/:slotId` | 编辑预约时段 | AdminAuth | `urn:bizmall:product:write` |
| DELETE | `/admin/v1/mall/products/:id/booking-slots/:slotId` | 删除预约时段 | AdminAuth | `urn:bizmall:product:write` |
...
| POST | `/admin/v1/mall/orders/:id/remark` | 添加订单备注 | AdminAuth | `urn:bizmall:order:write` |
| POST | `/admin/v1/mall/orders/:id/ship` | 手动发货 | AdminAuth | `urn:bizmall:order:write` |
...
| 方法 | 路径 | 摘要 | 认证 | 所需权限 |
|:----:|------|------|:----:|:----:|
| GET | `/admin/v1/settings` | 设置项列表 | AdminAuth | `urn:bizmall:settings:read` |
| POST | `/admin/v1/settings` | 创建设置项 | AdminAuth | `urn:bizmall:settings:write` |
| GET | `/admin/v1/settings/:id` | 设置项详情 | AdminAuth | `urn:bizmall:settings:read` |
| PUT | `/admin/v1/settings/:id` | 更新设置项 | AdminAuth | `urn:bizmall:settings:write` |
| DELETE | `/admin/v1/settings/:id` | 删除设置项 | AdminAuth | `urn:bizmall:settings:write` |
| PUT | `/admin/v1/settings/:id/enabled` | 启用/禁用设置项 | AdminAuth | `urn:bizmall:settings:write` |
